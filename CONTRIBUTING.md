# Contributing to Oh-My-Skills

Thank you for considering contributing to Oh-My-Skills! We believe in **Human Amplification, Not Replacement** - bringing out the best thinking in both humans and AI through guided collaboration.
...
Oh-My-Skills is a curated collection of agent skills generated by [Skill Forge](https://github.com/armelhbobdad/oh-my-skills). Good contributions improve the quality and breadth of skills available to the community.

**✅ Contributions that align:**

- New skills for popular libraries and frameworks
- Improvements to existing skill accuracy or coverage
- Documentation fixes and improvements
- Bug reports for incorrect API signatures or outdated content

**❌ What detracts from our mission:**

- Skills with hallucinated or unverified API content
- Skills without provenance citations
- Duplicate skills for libraries already covered
...
4. **Be specific** about why this feature would benefit the community
...
2. **Clone your fork** - `git clone https://github.com/YOUR-USERNAME/oh-my-skills.git`
...
- 🐛 Report bugs using the [bug report template](https://github.com/armelhbobdad/oh-my-skills/issues/new?template=bug_report.md)
- 💡 Suggest features using the [feature request template](https://github.com/armelhbobdad/oh-my-skills/issues/new?template=feature_request.md)
- 📖 Browse the [GitHub Discussions](https://github.com/armelhbobdad/oh-my-skills/discussions)
