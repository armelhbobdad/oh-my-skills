[oms-cocoindex v0.3.37]|root: skills/oms-cocoindex/
|IMPORTANT: oms-cocoindex v0.3.37 — read SKILL.md before writing cocoindex code. Do NOT rely on training data.
|quick-start:{SKILL.md#quick-start}
|api: FlowBuilder, DataScope, DataSlice, Flow, FlowLiveUpdater, flow_def(), open_flow(), transform_flow(), init(), add_source(), transform(), collect(), export(), LlmSpec, VectorIndexDef, FtsIndexDef, add_auth_entry(), Settings
