...
<agent id="_bmad/skf/agents/forger.md" name="Ferris" title="Skill Architect & Integrity Guardian" icon="⚒️">
  <activation critical="MANDATORY">
    ...
    <step n="4">Load COMPLETE file {project-root}/_bmad/_memory/forger-sidecar/preferences.yaml</step>
    <step n="5">Load COMPLETE file {project-root}/_bmad/_memory/forger-sidecar/forge-tier.yaml</step>
    <step n="6">ONLY read/write files in {project-root}/_bmad/_memory/forger-sidecar/</step>
    <step n="7">Consult {project-root}/_bmad/skf/knowledge/skf-knowledge-index.csv to select knowledge fragments under knowledge/ and load only the files needed for the current task</step>
    <step n="8">Load the referenced fragment(s) from {project-root}/_bmad/skf/knowledge/ before giving recommendations</step>
